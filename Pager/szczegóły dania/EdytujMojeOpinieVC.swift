...
class EdytujMojeOpinieVC: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
       ...
       self.navigationItem.title = "L_EDYTUJ_OPINIE".localized()
       navigationItem.rightBarButtonItem = UIBarButtonItem(title: "L_ZAPISZ".localized(), style: .plain, target: self, action: #selector(zapisTapped))
        ...
        autorTextField.text = Shared.shared.moja_opinia.op_autor
        tytulTextField.text = Shared.shared.moja_opinia.op_tytul
        ...
        textView.text = Shared.shared.moja_opinia.op_tresc
        ...
        starsWyglad.rating = Double(Shared.shared.moja_opinia.op_wyglad)!
        starsSmak.rating =  Double(Shared.shared.moja_opinia.op_smak)!
        starsZapach.rating =  Double(Shared.shared.moja_opinia.op_zapach)!
        starsTemp.rating =  Double(Shared.shared.moja_opinia.op_temp)!
        starsIlosc.rating =  Double(Shared.shared.moja_opinia.op_ilosc)!
        starsCena.rating =  Double(Shared.shared.moja_opinia.op_cena)!
        starsOpis.rating =  Double(Shared.shared.moja_opinia.op_opis)!
        starsZdjecie.rating =  Double(Shared.shared.moja_opinia.op_foto)!
        starsCobytu.rating =  Double(Shared.shared.moja_opinia.op_cobytu)!
    ...
    //funkcje naśladujace placeholder w textView
    ...
    func zapisz_opinie()  -> Int  {
        ...
        let postString = ["op_id": Shared.shared.moja_opinia.op_id, //nowa opinia
...
extension EdytujMojeOpinieVC: UITextViewDelegate{
